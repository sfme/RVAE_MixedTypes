...
declare out_folder="../../outputs_experiments_i/${data_file}/RVAE_AVI"
...
python -u ../core_models/main.py --dataset-folder ${data_folder} --output-folder ${out_folder} --outlier-model RVAE --number-epochs 100 \
       --AVI --save-on --latent-dim 20 --layer-size 400 --verbose-metrics-epoch --activation ${ACTIVATION} --l2-reg ${L2_REG} --alpha-prior 0.95 --cuda-on